...
grep 'authentication failure' /home/parallels/Downloads/sampleauth.log.txt
echo ""
# uses grep to search the auth.log file to find all the failed logins (they are stored in auth.log)

echo "all activity between midnight and 6 AM:"
awk '$3 ~ /^(00|01|02|03|04|05|06:00)/' /home/parallels/Downloads/samplesyslog.txt
echo "" 
# uses awk and reg ex to get all the activity between midnight and 6 am from the syslog file
